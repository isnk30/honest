    ...
    <aside className="fixed left-4 top-1/2 -translate-y-1/2 flex flex-col items-center gap-1 rounded-lg border border-border bg-background p-0.5 shadow-md animate-in zoom-in-75 fade-in duration-200 delay-150 origin-left fill-mode-both">
        ...
        <AnimatePresence>
          {linkOpen && (
            <motion.div
              ...
              className="absolute left-full bottom-[-47px] ml-2 w-56 rounded-lg border border-border bg-background shadow-lg p-3 flex flex-col gap-2"
            >
              ...
              <input
                ...
                placeholder="https://"
                className="w-full rounded-md border border-border bg-muted px-2 py-1.5 text-xs outline-none focus:border-foreground transition-colors"
              />
              <div className="flex gap-1.5">
                <button
                  onClick={applyLink}
                  className="flex-1 rounded-md bg-foreground py-1.5 text-xs font-medium text-background hover:opacity-90 transition-opacity"
                >
                  Apply
                </button>
                {getLinkAtCursor() && (
                  <button
                    onClick={removeLink}
                    className="flex-1 rounded-md bg-muted py-1.5 text-xs font-medium text-muted-foreground hover:text-foreground transition-colors"
                  >
                    Remove
                  </button>
                )}
      ...
      <div className="relative">
        <button
          ...
          className={cn(
            "flex items-center justify-center rounded-md transition-colors hover:bg-muted hover:text-foreground active:scale-95",
            secondsLeft !== null
        ...
        {timerOpen && (
          <motion.div
            ...
            className="absolute left-full -bottom-0.5 ml-2 w-44 rounded-lg border border-border bg-background shadow-lg p-3 flex flex-col gap-2 overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between">
                ...
                >
                  ...
                  <div className="flex items-center justify-between gap-1">
                    <button
                      ...
                      className="flex h-6 w-6 items-center justify-center rounded-full bg-muted text-muted-foreground hover:text-foreground transition-colors text-sm leading-none"
                    >
                      −
                    </button>
                  ...
                  <button
                    onClick={startTimer}
                    className="flex items-center justify-center gap-1.5 rounded-md bg-foreground py-1.5 text-xs font-medium text-background hover:opacity-90 transition-opacity"
                  >
                    Start
